...
namespace TheMerchShop.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InventoryId,MerchID,WarehouseID,Quantity,PurchaseDate,PurchasePrice,SalePrice")] Inventory inventory)
        {
            ...
            ViewData["WarehouseID"] = new SelectList(_context.Warehouses, "WarehouseID", "Location", inventory.WarehouseID);
            return View(inventory);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var merchants =  _context.Merch.Select(a => new DropDown {Text = a.Type, Value = a.MerchID.ToString()});
            ...
            ViewData["merchants"] = new SelectList(merchants);
            ViewData["WarehouseID"] = new SelectList(_context.Warehouses, "WarehouseID", "Location");
            return View(inventory);
        }
